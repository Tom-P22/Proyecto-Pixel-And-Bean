...
public class ReportesPanel extends javax.swing.JPanel {
    ...
    private void generarReporte() {
        ...
        try {
            switch (filtro) {
                case "Hoy":
                    ventasFiltradas = controller.listarDelDia();
                    break;
                case "Ayer":
                    LocalDate ayer = hoy.minusDays(1);
                    ventasFiltradas = controller.listarTodas().stream()
                        .filter(v -> v.getFechaHora().toLocalDate().equals(ayer))
                ...
                case "Último mes":
                    ...
                    break;
                default:
                    ventasFiltradas = controller.listarTodas();
                    break;
            }
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(lblTotal, javax.swing.GroupLayout.DEFAULT_SIZE, 183, Short.MAX_VALUE))
