...
public class ProductoRepositoryImpl implements IProductoRepository {
    ...
    private static final String SQL_SELECT_ALL = "SELECT id, nombre, categoria, tipo, descripcion, precio, activo FROM producto";
    ...
    private static final String SQL_INSERT = "INSERT INTO producto (nombre, categoria, tipo, descripcion, precio, activo) VALUES (?, ?, ?, ?, ?, ?)";
    private static final String SQL_UPDATE = "UPDATE producto SET nombre = ?, categoria = ?, tipo = ?, descripcion = ?, precio = ?, activo = ? WHERE id = ?";
